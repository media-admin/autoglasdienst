...
/* Aktivierung des Excerpts für statische Seiten */
...
/* Font Awesome importieren */

function autoglasdienst_enqueue_icon_stylesheet() {
	wp_register_style( 'fontawesome', 'https:////maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css' );
	wp_enqueue_style( 'fontawesome');
}

add_action( 'wp_enqueue_scripts', 'autoglasdienst_enqueue_icon_stylesheet' );
